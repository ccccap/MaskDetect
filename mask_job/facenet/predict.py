...
def face_rec(face_img_list,retinaface,flag):
    ...
    while True:
        if len(face_img_list)!=0:
            ...
            if image is not None:
                ...
                continue
        elif (len(face_img_list)==0 and flag[0]==False):
            break
        # print("self.face=null")

    #老的 有些瑕疵
    # while True:
    #     if len(face_img_list)!= 0:
    #         image = face_img_list[0].copy()
    #         face_img_list.pop(0)
    #
    #
    #         frame = cv2.cvtColor(image, cv2.COLOR_BGR2RGB)
